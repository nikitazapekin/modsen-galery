...
export const categories = [
  ...
  { id: 3, image: Architecture, text: "Architecture" },
  { id: 4, image: Food, text: "Food" },
  { id: 5, image: Religion, text: "Religion" },
  { id: 6, image: Clothes, text: "Clothes" },
  { id: 7, image: Technologies, text: "Technologies" },
  { id: 8, image: Music, text: "Music" },
  { id: 9, image: Bussiness, text: "Bussiness" },
  { id: 10, image: Sport, text: "Sport" },
  { id: 11, image: Social, text: "Social" },
  { id: 12, image: Sky, text: "Sky" },
]
